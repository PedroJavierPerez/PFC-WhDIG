                    ...
                    <section class="filtro">
                         ...
                         <form id= "formFiltro">
                             ...
                             <input type="date" id="fechaFin">
                              ...
                              <input list ="provincia" name="pro" class="inp">
                        ...
                        <option value='<?php echo $provincia["provincia"]?>'></option>
                           ...
                           <?php }  ?>
                             ...
                             <input list="ciudad" name="ciu" id="ciud" class="inp">
                                 <datalist id="ciudad" >
                        ...
                        <option value='<?php echo $localidad["nombre"]?>'></option>
                           ...
                           <?php }  ?> 
                             ...
                             <input list="tipo" name="tip" class="inp">
                             ...
                             <input list="local" name="loc" class="inp">
                                 <datalist id="local">
